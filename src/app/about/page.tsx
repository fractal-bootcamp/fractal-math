                ...
                <div className="max-w-3xl mx-auto">
                    <div className="bg-gray-800/50 backdrop-blur-lg rounded-lg p-8 border border-gray-700">
                        ...
                        <p className="text-gray-300 mb-6">
                            We make complex mathematical concepts accessible and beautiful through
                            interactive visualizations. Our platform helps users explore the
                            fascinating world of fractals and geometric patterns.
                        </p>
                        ...
                        <p className="text-gray-300">
                            ...
                            inspiring the next generation of mathematicians and artists through
